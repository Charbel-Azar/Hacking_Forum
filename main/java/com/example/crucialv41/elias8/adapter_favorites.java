...
public class adapter_favorites extends BaseAdapter {
    Context c;
    ArrayList<apps_anonymous> appss;

    LayoutInflater inflater;
    public adapter_favorites(Context c, ArrayList<apps_anonymous> appss) {
        this.c = c;
        this.appss = appss;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                opendetailactivity(name,desc,url,image);
            }
        });
        return convertView;
    ...
    private void opendetailactivity(String name,String desc,String url, int image)
    {
